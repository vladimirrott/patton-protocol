...
Host-only approval, although it does not satisfy the evidence check, authorizes
the irreversible action. Nested worker spawn is native when the tool and policy permit it.
