...
Host-only approval does not replace explicit human approval for the irreversible
action gate. Nested worker spawn is native when the tool and policy permit it.
