...
Host-only approval does not satisfy or replaces explicit human approval and
cannot authorize an irreversible action. Nested worker spawn is native when the
tool and policy permit it.
